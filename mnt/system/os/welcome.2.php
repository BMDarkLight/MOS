    ...
    <body>M Edition 
        <div class='app' id='b'>
            ...
            <div class='appcontent'>
                <div style='width: 100%;background-color: gainsboro;border: outset;'><h1>Suggestions</h1></div>
                We suggest that you see this files after completing the operation:<br />
                - "Where Are Here?" At "/system/Where Are Here.mdoc"<br />
                - "System Demo" At "/system/system_demo.epk"<br />
                - "Examples (Monody Music)" At "/home/Examples"<br />
                - Share Documents On M Documents<br />
                - Explore On Explorer<br />
                <a href="welcome.3.php"><button>Thanks For Suggestions</button></a>
            </div>
        </div>
