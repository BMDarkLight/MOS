...
if (isset($_REQUEST['o'])) {
    ...
    if ($passr === $pass) {
        ...
        mkdir($dir . 'settings');
        file_put_contents($dir . 'avatar.png',file_get_contents('../../../system/os/lib/user.png'));
        file_put_contents($dir . 'settings/walpaper.png',file_get_contents('../../../system/os/lib/default_wal.png'));
        ...
        file_put_contents('../../../user/' . $slug . '/Examples.mlnk','/system/os/lib/Examples');
    } else {
...
<html>
    ...
    <body os="style:body1">
        <div os="alert">
            <h1>OS Installed</h1>
            M Edition OS 5.0 Installed On Your Server.<br />
            <a href='../../../../'><button>Use It</button></a>
            In : <br />
            <ul>
