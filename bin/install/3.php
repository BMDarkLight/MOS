...
if (isset($_REQUEST['o'])) {
    ...
    if (!is_dir('../../mnt/system/explorer')) {mkdir('../../mnt/system/explorer');}
    file_put_contents('../../mnt/system/explorer/desknm',$desknm);
    file_put_contents('../../mnt/system/explorer/deskmd',$deskmd);
